...
Functest::~Functest() { std::cout << "destruct" << inter << std::endl; }
int Functest::Pow(int32_t inVal) { return inVal * inVal; }
void Functest::Set(std::function<int32_t(int32_t)> inFunc) { func = inFunc; }
